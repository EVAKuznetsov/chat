...
const ChatInput = ({ currentDialogId, addMessage }) => {
	...
	return <BaseChatInput value={value} sendMessage={sendMessage} changeValue={changeValue} />
}
const mapStateToProps = state => ({ currentDialogId: state.dialogs.currentDialogId })
